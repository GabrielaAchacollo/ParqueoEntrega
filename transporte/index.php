...
<head>
    <?php
      $hd_titulo="LISTA DE TRASNPORTES";
      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
              <div class="row " >
              <div class="col s12 m8 l8" style="background: #f4b00f; text-align: center; color:#032049; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                <?php echo $hd_titulo; ?>
              </div>
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    foreach($transporte->mostrarTodo("estado=1") as $f)
                    {
                      ...
                      $traasig=$transporteasig->mostrarUltimo("idestado=1 and idtransporte=".$f['idtransporte']);  
                      if (count($traasig)>0) 
                      {
                        $estadoasig='ASIGNADO';
                      }else{
                    ...
                    <tr style="<?php echo $estilo ?>">
                      ...
                      <td><?php echo $estadoasig ?></td>
                      <td>
                        <a href="editar/?lblcode=<?php echo $lblcode ?>" class="btn-jh waves-effect darken-4 orange"><i class="fa fa-pencil-square"></i> editar</a>
                        <button class="btn-jh waves-effect darken-4 red" onclick="elim('<?php echo $f['idtransporte'] ?>');"><i class="fa fa-remov"></i> Eliminar</button>
