<?php
 ...
 $valor=dcUrl($lblcode);
 $esta=$estacionamiento->muestra($valor);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <?php
      $hd_titulo="ACTUALIZAR DATOS DE ESPACIO DE PARQUEO";
           ...
           <div class="col s12 m12 l12">
            <div id="persona" class="col s12 m12 l12  "><!-- blue lighten-4 -->
                 <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                  <input id="idestacionamiento" name="idestacionamiento" type="hidden" value="<?php echo $valor ?>">
                <div class="col s12 m12 l12">
                       ...
                       <div class="input-field col s12 m6 l6">
                          ...
                          <select id="idcategoria" name="idcategoria">
                           ...
                           <?php
                              ...
                              {
                                $sw="";
                                if ($esta['idcategoria']==$f['idcategoria']) {
                                   $sw="selected";
                                }
                                ?>
                        ...
                        <div class="input-field col s12 m6 l6">
                          <input id="idnombre" name="idnombre" type="text" value="<?php echo $esta['nombre'] ?>" class="validate">
                          <label for="idnombre">Nombre o Nro. del espacio:</label>
                        </div>
                        <div class="input-field col s12 m12 l12">
                          <input id="iddescripcion" name="iddescripcion" type="text" value="<?php echo $esta['descripcion'] ?>" class="validate">
