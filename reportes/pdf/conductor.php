            ...
            <td style="width:30%;">
	            ...
	            <tr>
	            	<td>
	            		...
	            		<div class="titPRI"><h3>LISTA DE CONDUCTOR EN GENERAL </h3></div>
	...
	$html = '
		<table class="tablaLIST">
			...
			<tbody>
				...
				$contar=0; 
				foreach($conductor->mostrarTodo("estado=1") as $f) 
				{
					...
					$html = $html.'
						<tr style="'.$estilo.'">
						  <td>'.$contar.'</td>
						  <td>'.$deje['carnet'].' '.$deje['expedido'].'</td>
						  <td>'.$deje['nombre'].' '.$deje['paterno'].' '.$deje['materno'].'</td>
						  <td>'.$deje['celular'].'</td>
						</tr>
					';
					//$nro++;
